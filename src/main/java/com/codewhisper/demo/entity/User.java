...
public class User {
    ...
    // Create default constructor for User
    public User() {
    }

    // Create constructor for User with id, name, email, password, roles
    ...
    // Create getters and setters for id, name, email, password, roles
    public Long getId() {
        return id;
    }
